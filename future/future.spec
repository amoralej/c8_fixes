...
#%%global commit 23989c4d61a5e3b2308b107efc1402bc727e8fe6
#%%global date 20190506
...
Source0: https://github.com/PythonCharmers/python-%{name}/archive/%{version}/%{name}-%{version}.tar.gz
BuildArch: noarch
...
TEST_OPTS=$(-k "not test_pow and not test_urllib2")
%else
TEST_OPTS=""
%endif
PYTHONPATH=$PWD/build/lib py.test-%{python3_version} $TEST_OPTS
popd
%endif
# with_python3
